...
if (file_exists($arch)) {
	...
	header("location: http://localhost/pizto/sync/execute.php?op=3&edo=1&hash=$hash&action=$action&td=$td");
} else {
	header("location: http://localhost/pizto/sync/execute.php?op=3&edo=0&hash=$hash&action=$action");
}
