...
echo '<a href="javascript:window.open(\'http://localhost/pizto/sync/execute.php?op=1\', \'_blank\', \'width=1,height=1,center=yes,help=no\')" class="btn-floating btn-sm blue-gradient"><i class="fa fa-download"></i></a>';
 ?></h1>
